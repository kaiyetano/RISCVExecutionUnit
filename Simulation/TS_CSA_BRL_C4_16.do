# Timing Simulation Script for CSA_BRL ExecUnit (Cyclone IV, 16-bit)

quit -sim

set TranscriptFile "TS_CSA_BRL_C4_16_transcript.txt"
...
echo "Loading SDF timing information from modelsim/CSA_BRL_C4_16.sdo..."
vsim -t 1ps -voptargs="+acc" -L altera_mf -L cycloneive -sdftyp /DUT=modelsim/CSA_BRL_C4_16.sdo work.ExecUnit_tb_timing
