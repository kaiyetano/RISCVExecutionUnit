# Timing Simulation Script for CSA_SFT ExecUnit (Cyclone IV, 16-bit)

quit -sim

set TranscriptFile "TS_CSA_SFT_C4_16_transcript.txt"
...
vcom -work work -2008 -explicit -stats=none modelsim/CSA_SFT_C4_16.vho
vcom -work work -2008 -explicit -stats=none ExecUnit_tb_16.vhd

echo "Starting timing simulation for CSA_SFT ExecUnit..."
echo "Loading SDF timing information from modelsim/CSA_SFT_C4_16.sdo..."
vsim -t 1ps -voptargs="+acc" -L altera_mf -L cycloneive -sdftyp /DUT=modelsim/CSA_SFT_C4_16.sdo work.ExecUnit_tb_timing
