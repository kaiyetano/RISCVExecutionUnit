# Functional Simulation Script for CSA_SFT ExecUnit (Arria II, 64-bit)
...
vsim -t 1ps -voptargs="+acc" work.ExecUnit_tb_CSA_SFT
...
echo "Functional simulation complete. Results saved to FS_CSA_SFT_A2_64_transcript.txt"
