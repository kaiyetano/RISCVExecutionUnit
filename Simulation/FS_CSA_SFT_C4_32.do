# Functional Simulation Script for ExecUnit CSA_SFT on Cyclone IV (32-bit)

quit -sim

set TranscriptFile "FS_CSA_SFT_C4_32_transcript.txt"
...
echo "Starting functional simulation for CSA_SFT ExecUnit (32-bit)..."
vsim -t 1ps -voptargs="+acc" -gN=32 -gArithType="ConditionalSum" -gShiftType="Sft64" work.ExecUnit_tb(Behaviour)
