# Functional Simulation Script for ExecUnit BKA_SFT on Arria II (64-bit)

quit -sim

set TranscriptFile "FS_BKA_SFT_A2_64_transcript.txt"
...
vcom -work work -2008 -explicit -stats=none ../SourceCode/ExecUnit_BKA_SFT.vhdl
vcom -work work -2008 -explicit -stats=none ExecUnit_tb.vhd

echo "Starting functional simulation for BKA_SFT ExecUnit..."
vsim -t 1ps -voptargs="+acc" work.ExecUnit_tb_BKA_SFT
